...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2022 at 03:59 AM
...
CREATE TABLE `incident` (
  `incident_id` int(11) NOT NULL COMMENT 'Primary Key',
  `caller_name` varchar(30) NOT NULL,
  `phone_number` varchar(10) NOT NULL,
  `incident_type_id` varchar(3) NOT NULL COMMENT 'Foreign Key',
  `incident_location` varchar(50) NOT NULL,
  `incident_desc` varchar(100) NOT NULL,
  `incident_status_id` varchar(1) NOT NULL COMMENT 'Foreign Key',
...
(1, 'Peter Leow', '61234567', '060', 'Five Foot Way', 'Fatal, 5 Car Collision', '1', '2013-12-11 16:04:39');
...
--
ALTER TABLE `incident`
  MODIFY `incident_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=3;
