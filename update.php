...
if ($btnSearchClicked == true) {
	...
	// Use while loop to extract each rows into array var statuses
...
// Create var btnUpdateClicked to check if btnUpdate has been clicked
	...
	<body>
		<div class="container" style="width: 80%">
			...
			<section style="margin-top: 20px">
				<!-- Create web form with Patrol Car Number input fields -->
