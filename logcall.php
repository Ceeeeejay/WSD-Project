<?php
	...
	while ($row = $result->fetch_assoc()) {
		...
		// using the array_push function to assign all rows the result-set into array var incidentsTypes
...
<html>
	...
	<body>
		<div class="container" style="width: 80%">
			<!-- Use php require_once expression to include header and navigation bar from nav.php -->
			...
			<form action="dispatch.php" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="callerName" class="form-control" id="callerName" pattern="[a-zA-Z ]{1,}">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-lg-8">
						<input type="text" name="contactNo" class="form-control" id="contactNo" required pattern="[0-9]{8,8}">
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="descriptionofIncident" class="col-lg-4 col-form-label">Desciption of Incident (Required)</label>
					<div class="col-lg-8">
